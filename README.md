...
* DELETE
    * **/api/sku/id** - Delete record from Sku model having id field as per id passed in URI
    * **/api/order/id** - Delete record from Order model having id field as per id passed in URI
    * **/api/storage/id** - Delete record from Storage model having id field as per id passed in URI
    * **/api/orderline/id** - Delete record from OrderLine model having id field as per id passed in URI
